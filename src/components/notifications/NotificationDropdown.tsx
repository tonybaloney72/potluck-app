	...
	return (
		<div className='relative' ref={dropdownRef}>
			...
			<button
				...
				className='relative p-2 rounded-lg active:scale-95 transition-all duration-200 focus:outline-none hover:cursor-pointer flex justify-center items-center'
				...
				type='button'>
				<FaBell
					className='w-5 h-5 text-primary hover:text-accent-secondary'
					aria-hidden='true'
				/>
				{unreadCount > 0 && (
					<span
